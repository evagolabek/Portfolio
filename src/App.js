            ...
            <div className='content'>
              ...
              <div className="nav-bar">
                ...
                <div className='profile-img'>
                  <img src={'/images/me.png'} alt="" /></div>
                <div className="title"> Eva Golabek-Puget</div>
                <div className='about'>
                  <br/>
                  I am a junior web developer with previous experience and interest in fashion and marketing.
                  I have strong interpersonal skills developed both within education and work.
                  My other strengths are that I am a fast learner, highly self-motivated and adaptable to changing circumstances and environments
                </div>
